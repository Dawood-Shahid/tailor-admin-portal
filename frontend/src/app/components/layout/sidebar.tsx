...
const Sidebar = () => {
  return (
    <div className="h-screen background flex flex-col background-secondary">
      {/* Header Container */}
      <div className="separator-bottom h-20 mb-4 flex-shrink-0">
        <div className="h-full flex flex-row background-secondary items-end justify-center pb-2">
